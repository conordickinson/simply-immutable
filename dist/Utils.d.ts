...
export declare function updateImmutable<T>(root: Readonly<T>, value: Readonly<Partial<T>>): Readonly<T>;
...
export declare function deepUpdateImmutable<T>(root: Readonly<T>, value: Readonly<Partial<T>>): Readonly<T>;
